...
export default function About() {
  ...
  return (
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .rung-price { padding: 24px 28px; border-right: 1px solid rgba(var(--rgb-warm-grey2),0.08); font-family: var(--fd); font-size: 24px; font-weight: 300; letter-spacing: -.02em; color: var(--gold); }
