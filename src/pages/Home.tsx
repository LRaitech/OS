  ...
  return (
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-scrim {
      ...
      background: linear-gradient(to top, rgba(240,235,225,0.98) 0%, rgba(240,235,225,0.72) 45%, rgba(240,235,225,0.18) 80%, transparent 100%);
    }
    .hero-content { position: relative; z-index: 2; max-width: 860px; }
    .eyebrow {
      font-family: var(--fm); font-size: 9px; font-weight: 400;
      letter-spacing: .18em; text-transform: uppercase; color: var(--gold);
      border: 1px solid rgba(184,134,11,0.28); padding: 5px 12px;
    ...
    .btn-ghost {
      ...
      border-bottom: 1px solid rgba(139,115,85,0.30); padding-bottom: 2px; transition: all .15s;
    }
    ...
    .proof-bar {
      ...
      border-top: 1px solid rgba(90,74,53,0.10);
      border-bottom: 1px solid rgba(90,74,53,0.10);
      position: relative; z-index: 1;
    }
    .proof-item { padding: 32px 40px; border-right: 1px solid rgba(90,74,53,0.08); }
    ...
    /* TRACKS */
    .tracks { display: grid; grid-template-columns: 1fr 1fr; gap: 1px; background: rgba(90,74,53,0.10); border: 1px solid rgba(90,74,53,0.10); margin-top: 48px; }
    ...
    .track.AI Frameworks .track-cta { background: var(--gold-thin); border: 1px solid rgba(184,134,11,0.40); color: var(--gold); }
    .track.AI Frameworks .track-cta:hover { background: var(--gold); color: var(--cream); }
    .track.strategy .track-cta { background: transparent; border: 1px solid rgba(90,74,53,0.30); color: var(--warm-grey2); }
    .track.strategy .track-cta:hover { border-color: var(--ink); color: var(--ink); }

    /* ROOMS GRID */
    .rooms-grid { display: grid; grid-template-columns: repeat(5,1fr); gap: 1px; background: rgba(90,74,53,0.10); border: 1px solid rgba(90,74,53,0.10); margin-top: 48px; }
    ...
    .room-card.coming .room-price { color: rgba(139,115,85,0.45); }
    ...
    .rung-price { padding: 24px 28px; border-right: 1px solid rgba(90,74,53,0.08); font-family: var(--fd); font-size: 28px; font-weight: 300; letter-spacing: -.02em; }
    ...
    .rung-body { padding: 24px 32px; border-right: 1px solid rgba(90,74,53,0.08); }
    ...
    .sprint-price-block { padding: 40px; border: 1px solid rgba(184,134,11,0.25); background: var(--cream); text-align: center; }
...
<header className="hero">
  <svg className="hero-art" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
      <radialGradient id="g1" cx="75%" cy="20%" r="60%"><stop offset="0%" stopColor="#D4A84B" stopOpacity="0.18"/><stop offset="100%" stopColor="transparent"/></radialGradient>
      <radialGradient id="g2" cx="12%" cy="80%" r="55%"><stop offset="0%" stopColor="#8B7355" stopOpacity="0.12"/><stop offset="100%" stopColor="transparent"/></radialGradient>
    </defs>
    <rect width="1440" height="900" fill="#F0EBE1"/>
    <rect width="1440" height="900" fill="url(#g1)"/>
    <rect width="1440" height="900" fill="url(#g2)"/>
    
    <g opacity="0.05" stroke="#5A4A35" fill="none" transform="translate(1100,200)">
    ...
    <g opacity="0.04" stroke="#5A4A35" fill="none" transform="translate(180,650)">
      <circle cx="0" cy="0" r="100"/><circle cx="0" cy="0" r="155"/><circle cx="0" cy="0" r="200"/>
    </g>
    
    <g opacity="0.09" stroke="#2A1F14" fill="#2A1F14">
    ...
    <g opacity="0.10" fill="none" stroke="#8B7355" transform="translate(950,380)">
    ...
    <g opacity="0.025" stroke="#2A1F14" strokeWidth="0.4">
    ...
    <path d="M0,750 C300,720 600,780 900,750 C1100,728 1300,760 1440,745 L1440,900 L0,900Z" fill="#D4A84B" opacity="0.06"/>
  </svg>
